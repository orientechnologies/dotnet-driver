...
namespace OrientDB.Net.ConnectionProtocols.Binary.Tests.CoreTests
{
    ...
    public class WhenUsingTheOrientDBBinaryConnection
    {
        ...
        {
            Assert.Throws(typeof(ArgumentNullException), () => new OrientDBBinaryConnection(null, null, null, null));
        }
        ...
        public void ItShouldThrowAnExceptionWhenPassedANUllSerializer()
        {
            ...
            Assert.Throws(typeof(ArgumentNullException), () => new OrientDBBinaryConnection(options, null, null, null));
        }
